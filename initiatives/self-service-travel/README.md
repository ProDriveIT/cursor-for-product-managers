...
- [ ] Work-order #1 and #2 exited
- [ ] Sprint day completed
- [ ] User research / last-180-day signals (≥3)
- [ ] Riskiest assumptions test designs complete (A1/A2)
- [ ] Success criterion (OMTM) chosen
- [ ] Strategy revised past intake
- [ ] PRD drafted

## Start here

1. [`sprint-prep.md`](./sprint-prep.md) — pre-sprint checklist  
2. [`evidence-sprint-1day.md`](./evidence-sprint-1day.md) — sprint day agenda (after #1/#2)

## Folder structure

- **[evidence/](./evidence/)** — `signals-180d.md` + other signals
- **[assumptions/](./assumptions/)** — `riskiest-assumptions.md`
- **[user-interviews/](./user-interviews/)** — transcripts, snapshots, synthesis
- **[opportunities/](./opportunities/)** — Opportunity Solution Tree nodes
- **[solutions/](./solutions/)** — solution explorations
- **[product-analytics/](./product-analytics/)** — `baseline-msp-org.md`
- **[prd/](./prd/)** — success criterion + 2-week discovery plan

## Notes

Do not treat reporting, one-click deploy, and onboarding as committed roadmap until the evidence gate returns PROCEED. Do not run sprint day ahead of EOS L10-ready and one-client full HTML.
